...
VALUES ('2023-01-10 10:00:00', '00000000000', 1, '100'),
       ('2023-01-11 11:00:00', '00000000000', 2, '200'),
       ('2023-01-12 12:00:00', '00000000001', 3, '150');

-- Inserting data into the foto table
INSERT INTO foto (id_pet, cliente_cpf, tipo, dados)
VALUES
    (1, '00000000000', 'JPEG', null),
    (1, '00000000000', 'PNG', null),
    (2, '00000000001', 'JPEG', null),
    (3, '00000000001', 'PNG', null);